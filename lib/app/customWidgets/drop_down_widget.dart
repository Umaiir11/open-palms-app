...
class DropDownWidgetTwo<T> extends StatelessWidget {
  final T? selectedValue;
  final void Function(T?)? onChanged;
  final List<T> itemsList;
  final Color? borderColor;
        ...
        children: [
          ...
          Row(
            children: [
              Text(
                title,
                style: AppTextStyles.customText(fontSize: 16, color: Colors.black, fontWeight: FontWeight.w500),
              ),
              if (isRequired ?? false) Text(' *', style: AppTextStyles.customText14(color: AppColors.primary)),
            ],
          ),
                ...
                child: DropdownButton2<T>(
                  ...
                  buttonStyleData: ButtonStyleData(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: AppColors.textLightBlack.withOpacity(0.2)),
                    ),
                  ),
                  iconStyleData: IconStyleData(
